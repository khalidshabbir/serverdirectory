...
// ======================================================
router.post("/register/reviews",
    uploadimg.single("image"),
    async (req, res) => {
        const file = req.image;
        try {

            const listcompany = new Review({
                name: req.body.name,
...
// ============================================
router.get("/reviews/getdata", async (req, res) => {
    try {
...
// ==========================================================
router.post("/update/reviews", uploadimg.single("image"), async (req, res) => {
    ...
    try {
        ...
        if (req.file) {
            ...
            const update = await Review.findByIdAndUpdate(req.body.id, userdatails, {
                new: true,
            });
        } else {
